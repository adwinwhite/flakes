...
function nvim_lsp(name, setup) 
	vim.lsp.config(name, setup)
	vim.lsp.enable(name)
end
nvim_lsp("volar", {})
nvim_lsp("racket_langserver", {
	autostart = false,
})
nvim_lsp("fortls", {})
nvim_lsp("buf_ls", {})
nvim_lsp("basedpyright", {})
nvim_lsp("nixd", {})
nvim_lsp("gopls", {})
...
local language_servers = vim.tbl_keys(vim.lsp._enabled_configs) -- or list servers manually like {'gopls', 'clangd'}
